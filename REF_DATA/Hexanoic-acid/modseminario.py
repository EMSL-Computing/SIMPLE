...
def main():
    ...
    elements = [np.str_('C'), np.str_('C'), np.str_('C'), np.str_('C'), np.str_('C'), np.str_('C'), np.str_('O'), np.str_('O'), np.str_('H'), np.str_('H'), np.str_('H'), np.str_('H'), np.str_('H'), np.str_('H'), np.str_('H'), np.str_('H'), np.str_('H'), np.str_('H'), np.str_('H')]
    for i in range(len(elements)):
        elements[i] = elements[i].capitalize()

    names    = [np.str_('C'), np.str_('C'), np.str_('C'), np.str_('C'), np.str_('C'), np.str_('C'), np.str_('O'), np.str_('O'), np.str_('H'), np.str_('H'), np.str_('H'), np.str_('H'), np.str_('H'), np.str_('H'), np.str_('H'), np.str_('H'), np.str_('H'), np.str_('H'), np.str_('H')]
